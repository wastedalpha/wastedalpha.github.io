...
// the wave daemons
const CA = "0xA19E4e646DcC533b43caC8c4c4C7D162a3116054";
...
let saleStart;
let mintFees;
const rpc = 'https://rpc.ankr.com/eth/df5cbff461074dfe91274a7ad34c11f08dffff87b956fe09369aab1c06bc7c6b';
      ...
      networkData = [
        {
          chainId: "0x1",
          chainName: "Ethereum",
          rpcUrls: ["https://rpc.ankr.com/eth/df5cbff461074dfe91274a7ad34c11f08dffff87b956fe09369aab1c06bc7c6b"],
          nativeCurrency: {
            name: "ethereum",
            symbol: "ETH",
            decimals: 18,
...
async function onConnect() {
  ...
  await swapChain("0x1", 1); //SWAP FOR ETH MAINNET
